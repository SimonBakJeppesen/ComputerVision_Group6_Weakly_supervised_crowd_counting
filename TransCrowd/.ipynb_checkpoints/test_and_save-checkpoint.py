...
def validate(Pre_data, model, args):
    ...
    f = open("/home/cv06f23/ComputerVision_Group6_Weakly_supervised_crowd_counting/TransCrowd/output.txt", "w") # open file
    for i, (fname, img, gt_count) in enumerate(test_loader):
        ...
        f.write(str(fname)+";"+str(gt_count)+";"+str(count)+";\n") # save gt and count to file

...
def alt_gvt_large(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        checkpoint = torch.load('/home/cv06f23/ComputerVision_Group6_Weakly_supervised_crowd_counting/CCTrans/model_weights/alt_gvt_large.pth') # todo pass path as argument

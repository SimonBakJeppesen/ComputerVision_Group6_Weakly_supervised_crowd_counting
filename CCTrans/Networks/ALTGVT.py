...
def alt_gvt_large(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        checkpoint = torch.load('/home/cv09f23/ComputerVision_Group6_Weakly_supervised_crowd_counting/CCTrans/model_weights/alt_gvt_large.pth') # todo pass path as argument
        model.load_state_dict(checkpoint, strict=False)
        print("load transformer pretrained")
    return model
